    ...
    <div className="">
      ...
      <div className=" mt-20  flex items-center justify-center relative w-[420px] h-[350px]">
        ...
        <div className=" absolute flex flex-col items-center justify-start top-5">
          <p className=" font-semibold  text-2xl sm:text-2xl lg:text-2xl  1xl:text-4xl 3xl:text-5xl text-gray-500">Opt-In pool</p>
          <p className=" text-center px-14 mt-3 text-gray-600">Submit the transaction below to opt-in to the CULTmander pool.Note: it is required to have $250 RVLT staked at the time of opting in. Unstaking any amount will remove you from the pool.</p>
      ...
      <div className=" flex items-center justify-center mt-0 relative">
        ...
        <div className="  -top-5  text-gray-600 font-serif flex flex-col 3xl:w-108 2xl:w-80 xl:w-60 3xl:h-36 2xl:h-28 xl:h-20 sm:w-56 w-36 absolute items-center justify-evenly sm:h-16 h:10 sm:mt-8 mt-9"><p className="3xl:text-4xl 2xl:text-3xl  text-md sm:text-xl font-Nixie font-semibold">OPTmander</p><p className="3xl:text-4xl 2xl:text-3xl  text-md sm:text-xl font-Nixie font-semibold">No</p></div>
      </div>
